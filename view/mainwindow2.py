...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.print = QtWidgets.QPushButton(self.status)
        self.print.setObjectName("print")
        self.gridLayout_2.addWidget(self.print, 4, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tsmiPrinter.setText(_translate("MainWindow", "打印机"))
        self.tsmiPageset.setText(_translate("MainWindow", "打印设置"))
